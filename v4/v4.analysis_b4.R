...
# #sensitivity of PSUs.
# psu.res[,1:2]
# #sensitivity of individual sample points
# vec.prob.pos[samples$ID]
# #sensitivity of the sample from pumping station
# uf.prob.pos
...
#pdf(file=paste0("./",version,"/output/res_pooling_",lambda,"_",Sys.Date(),".pdf"),width=14,height=10)
...
points(iterative.ssn@obspoints@SSNPoints[[1]]@point.coords[samples[,2],1], 
       ...
       cex=1)
#cex=(std.vec.prob.pos*2)[samples[,2]])
